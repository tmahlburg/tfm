...
class Ui_tfm(object):
    def setupUi(self, tfm):
        ...
        self.fs_tree.setProperty(u"showDropIndicator", True)
        ...
        self.table_view.viewport().setProperty(u"cursor", QCursor(Qt.CursorShape.ArrowCursor))
        ...
        tfm.addToolBar(Qt.ToolBarArea.TopToolBarArea, self.toolbar)
