...
class Ui_tfm(object):
    def setupUi(self, tfm):
        ...
        self.action_remove_from_bookmarks = QAction(tfm)
        self.action_remove_from_bookmarks.setObjectName(u"action_remove_from_bookmarks")
        ...
        self.fs_tree.setFrameShadow(QFrame.Sunken)
        self.fs_tree.setProperty("showDropIndicator", False)
        self.fs_tree.setRootIsDecorated(False)
        self.hsplit.addWidget(self.fs_tree)
        self.fs_tree.header().setVisible(False)
        self.bookmarks = QListWidget(self.hsplit)
        self.bookmarks.setObjectName(u"bookmarks")
        self.bookmarks.setFrameShadow(QFrame.Sunken)
        self.bookmarks.setDragDropMode(QAbstractItemView.DragDrop)
        self.bookmarks.setDefaultDropAction(Qt.ActionMask)
        self.bookmarks.setMovement(QListView.Free)
        self.hsplit.addWidget(self.bookmarks)
        ...
        self.table_view.setLocale(QLocale(QLocale.German, QLocale.Germany))
        self.table_view.setFrameShadow(QFrame.Plain)
    ...
    def retranslateUi(self, tfm):
        ...
        self.action_remove_from_bookmarks.setText(QCoreApplication.translate("tfm", u"Remove from bookmarks", None))
